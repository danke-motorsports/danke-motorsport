...
A arquitetura do projeto foi desenhada para ser escalável e separar claramente as responsabilidades de interface e regra de negócio:

* **Front-end:** React, JavaScript, HTML5, CSS3 (Responsivo para Desktop e Mobile).
* **Back-end (API):** C# .NET.
* **Banco de Dados:** MongoDB (NoSQL).

## ⚙️ Funcionalidades Principais (MVP)

* **Para o Cliente (Lead):** Landing page responsiva, apresentação de serviços e formulário de agendamento online de revisões/diagnósticos.
* **Para a Oficina (Admin):** Sistema de autenticação seguro, dashboard para visualização de leads, e gestão (CRUD) de horários e status dos serviços.
